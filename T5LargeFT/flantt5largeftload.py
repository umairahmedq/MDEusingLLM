...
model_path = '/home/jovyan/shared/Umair/models/finetuned/flant5largekeywordscrt'
model = T5ForConditionalGeneration.from_pretrained(model_path)
tokenizer = T5Tokenizer.from_pretrained(model_path)

# Load the CSV file
df = pd.read_csv("/home/jovyan/trainingmodel/keywordscourse/flant5largert/test_keywords.csv")  # Replace with your actual CSV file path
...
def generate_keywords(description):
    ...
    input_text = "Generate 3 to 12 keywords for the following dataset description: " + description
    
    # Tokenize the input
    input_ids = tokenizer(input_text, return_tensors="pt").input_ids
    
    # Generate keywords using the model
    output_ids = model.generate(input_ids, max_new_tokens=50, repetition_penalty=3.0, temperature=0.7, do_sample = True, no_repeat_ngram_size=3)
...
df.to_csv("/home/jovyan/trainingmodel/keywordscourse/flant5largert/test_keywords_results.csv", index=False)
